 ...
 * full programme". min-h-11 below sm and the old 32px from sm up, the same
 * split the Input and the schedule selects use.
 */
export const ACTION_LINK =
  "inline-flex min-h-11 items-center rounded-control px-2 text-sm font-medium text-primary underline-offset-4 transition-colors duration-fast hover:underline active:text-accent-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent-500 sm:h-8 sm:min-h-0";
